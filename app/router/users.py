...
from ..schemas.user import UserCreate, UserResponse, UserListResponse  # Updated schemas
...
@user_router.get(
    "/show/{id}", status_code=status.HTTP_200_OK, response_model=UserResponse
)
...
@user_router.put(
    "/update/password/{id}", status_code=status.HTTP_200_OK, response_model=UserResponse
)
